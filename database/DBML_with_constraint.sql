...
Table "accounts" {
  "account_id" int(11) [unique, pk, not null, increment]
...
Table "brands" {
  "brand_id" int(11) [unique, pk, not null, increment]
...
Table "categories" {
  "categories_id" int(11) [unique, pk, not null, increment]
  "categories_name" varchar(100) [default: "", note: "Ex: Tủ lạnh, máy giặt,..."]
  "is_active" bit(1) [default: 1]
}

Table "customers" {
  "customer_id" int(11) [unique, pk, not null, increment]
...
Table "decentralizations" {
  "decentralization_id" int(11) [unique, pk, not null, increment]
  "role_id" int(11) [not null]
...
Table "exports" {
  "export_id" int(11) [unique, pk, not null, increment]
...
Table "functions" {
  "function_id" int(11) [unique, pk, not null, increment]
  "function_name" varchar(100) [default: ""]
  "is_active" bit(1) [default: 1]
}

Table "imports" {
  "import_id" int(11) [unique, pk, not null, increment]
  "staff_id" int(11) [not null]
...
Table "modules" {
  "module_id" int(11) [unique, pk, not null, increment]
  "module_name" varchar(200) [default: ""]
  "is_active" bit(1) [default: 1]
}

Table "orders" {
  "order_id" int(11) [unique, pk, not null, increment]
...
Table "order_details" {
  "order_detail_id" int(11) [unique, pk, not null, increment]
...
Table "products" {
  "product_id" int(11) [unique, pk, not null, increment]
...
Table "product_images" {
  "product_image_id" int(11) [unique, pk, not null, increment]
  "product_id" int(11) [not null]
...
Table "roles" {
  "role_id" int(11) [unique, pk, not null, increment]
  "role_name" varchar(20) [not null]
  "is_active" bit(1) [default: 1]
}

Table "shipments" {
  "shipment_id" int(11) [unique, pk, not null, increment]
...
Table "skus" {
  "sku_id" int(11) [unique, pk, not null, increment]
...
Table "staffs" {
  "staff_id" int(11) [unique, pk, not null, increment]
...
Table "wages" {
  "wage_id" int(11) [unique, pk, not null, increment]
...
Table "wage_details" {
  "wage_detail_id" int(11) [unique, pk, not null, increment]
...
Ref "accounts_ibfk_1":"roles"."role_id" < "accounts"."role_id"
...
Ref "wage_details_ibfk_1":"staffs"."staff_id" < "wage_details"."staff_id"

Ref "wage_details_ibfk_2":"wages"."wage_id" < "wage_details"."wage_id"
