<?php
    ...
    class CustomerService extends Service{
        ...
        public function createCustomer(){
            $customer = new CustomerModel("Nguyễn Thị Lụa", "5", "9", "1", "0936363636", "lua@gmail.com", "Nghĩa Địa Gia Đôi", "2003-05-22");
        ...
        public function updateCustomer(){// by id (truyền DTO)
            ...
            $customer = new CustomerModel(
                "Nguyễn Huỳnh Thị Lụa", $role_id, $account_id, $gender, $phone_number, $customer_email, $address, $date_of_birth, $customer_id, $is_active
            );
