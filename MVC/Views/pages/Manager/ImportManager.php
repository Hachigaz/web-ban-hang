...
<div class="modal hide ">
    <!-- Xóa nhân viên -->    <div class="modal-inner modal-info hide">
        ...
        <div class="modal-body">
            <div class="info-section">
                <div class="input-section">
                    <div class="combobox-filter">
                        <select name="" id="role-filter">
                            <option value="Chức vụ">Chọn nhà cung cấp</option>
                        </select>
                    </div>
                    <br>
                ...
                <div class="input-section">
                    <div class="combobox-filter">
                        <select name="" id="role-filter">
                            <option value="Chức vụ">Chọn loại hàng</option>
                        </select>
                    </div>
                    <br>
                ...
                <div class="input-section">
                    <div class="combobox-filter">
                        <select name="" id="role-filter">
                            <option value="Chức vụ">Chọn hãng</option>
                        </select>
                    </div>
                    <br>
                ...
                <div class="input-section">
                    <div class="combobox-filter">
                        <select name="" id="role-filter">
                            <option value="Chức vụ">Chọn sản phẩm</option>
                        </select>
                    </div>
                    <br>
                    <input type="text" name="fullname_add_form" placeholder="Sản phẩm..." class="fullname-add-form" readonly autocomplete="off" id="fullname_add_form">
                    <br>
                </div>
                <div class="input-section">
                        <label for="fullname_edit_form" class="label-form">Đơn giá</label>
                        <br>
                        <input type="text" name="fullname_edit_form" placeholder="Đơn giá..." class="fullname-edit-form" autocomplete="off" id="fullname_edit_form">
                        <br>
                </div>
                <div class="input-section">
                        <label for="fullname_edit_form" class="label-form">Số lương</label>
                        <br>
                        <input type="text" name="fullname_edit_form" placeholder="Số lượng..." class="fullname-edit-form" autocomplete="off" id="fullname_edit_form">
                        <br>
                </div>
            </div>
        ...
        <div class="modal-footer">
            <button class="close" id="closeBtnInfo">Thêm</button>
            <button class="close" id="closeBtnInfo">Tạo</button>
